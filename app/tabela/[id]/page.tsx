    ...
    <main className="min-h-screen bg-[#0f0f0f]">
      <header className="border-b border-[#2a2a2a] px-6 py-4 flex items-center gap-4">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-white font-bold text-lg capitalize">{hoje}</h1>
        </div>
        <button
          onClick={() => router.push(`/tabela/${id}/nova-entrega`)}
          className="flex items-center gap-2 bg-[#F5A623] hover:bg-[#e09b1a] text-[#1a1a1a] font-bold px-4 py-2 rounded-xl text-sm transition-colors">
      ...
      <div className="max-w-3xl mx-auto px-4 py-6">
        {loading ? (
          ...
          <div className="text-center py-16">
            <p className="text-[#444] text-sm">Nenhuma entrega registrada ainda.</p>
            <p className="text-[#333] text-xs mt-1">Clique em "+ Entrega" para começar.</p>
          </div>
        ) : (
